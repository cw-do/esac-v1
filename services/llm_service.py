...
When answering questions about instrument configurations:
1. Look for the 'Currently_Existing_Configurations' section in the provided context
2. List the configurations exactly as they appear in that section and be complete about it.
...
6. When discussing instrument configurations, refer to the 'Currently_Existing_Configurations' section in the provided context."""
