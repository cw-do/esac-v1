...
%
% Deployed to beamline note
ESAC v1 has been deployed to the EQ\textendash SANS (BL\-6) beamline at the Spallation Neutron Source for operational use by instrument scientists and beamline staff; early in‑beamline use indicates improved experiment preparation efficiency and smoother script reuse workflows.

ESAC v1 has been deployed to the EQ‑SANS (BL‑6) beamline at the Spallation Neutron Source for operational use by instrument scientists and beamline staff; initial in‑beamline use indicates improved experiment preparation efficiency and smoother script reuse workflows.
